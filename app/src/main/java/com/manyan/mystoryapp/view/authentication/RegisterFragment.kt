package com.manyan.mystoryapp.view.authentication
...
import com.manyan.mystoryapp.databinding.RegisterFragmentBinding
//import com.manyan.mystoryapp.utils.ext.isEmailValid
...
//                when {
//                    userName.isBlank() -> binding.nameEditText.error = getString(string.error_empty_name)
//                    userEmail.isBlank() -> binding.emailEditText.error = getString(string.error_empty_email)
//                    !userEmail.isEmailValid() -> binding.passwordEditText.error = getString(string.error_invalid_email)
//                    userPassword.isBlank() -> binding.passwordEditText.error = getString(string.error_empty_password)
//                    else -> {
