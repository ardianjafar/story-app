...
import com.elapp.mystoryapp.presentation.profile.AboutDev
import com.elapp.mystoryapp.presentation.profile.ProfileActivity
import com.elapp.mystoryapp.presentation.story.StoryAdapter
import com.elapp.mystoryapp.presentation.story.StoryViewModel
import com.elapp.mystoryapp.presentation.story.add.AddStoryActivity
import com.elapp.mystoryapp.utils.SessionManager
import com.elapp.mystoryapp.R.string
import com.elapp.mystoryapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when(item.itemId) {
            ...
            R.id.aboutDeveloper -> {
                Intent(this, AboutDev::class.java).also {
                    startActivity(it)
                }
            }
        }
